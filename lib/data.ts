...
export const INITIAL_RULES: DisciplineRule[] = [
  ...
  { code: 27, description: "Ausentar-se da sala de aula, instrução ou de qualquer atividade escolar, sem a devida autorização; (fugir da aula, sair sem permissão, gazear)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 28, description: "Apresentar-se à Monitoria, Coordenação ou a Secretaria para tratar de assunto de interesse particular sem a devida autorização; (assunto pessoal, sem autorização)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 29, description: "Atribuir-se a qualidade de representante da EECM, sem estar devidamente autorizado; (falsidade, representação indevida)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 30, description: "Brincar de lutas, dar apelidos a colegas, professores ou funcionários da escola e rir de maneira excessiva em local e momento impróprio; (apelido, bullying, brincadeira de mão, luta)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 31, description: "Cantar, assobiar ou fazer ruído em local e momento impróprio; (barulho, canto, assobio)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 32, description: "Conduzir veículo motorizado nas dependências da EECM e em seu entorno, quando uniformizado; (moto, carro, dirigir, pilotar)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 33, description: "Deixar de cumprir ordem recebida, referente a normas e regulamentos da EECM; (desobediência, insubordinação)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 34, description: "Demonstrar falta de posturas militares em local público, estando uniformizado; (postura, comportamento, militarismo)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 35, description: "Desrespeitar as normas de segurança da EECM; (segurança, perigo, norma)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 36, description: "Entrar ou sair da EECM por locais não permitidos; (pular muro, saída não autorizada)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 37, description: "Estar o aluno, em local ou dependência da EECM, cujo acesso lhe seja vedado; (área restrita, proibido)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 38, description: "Faltar com a verdade; (mentira, enganação)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 39, description: "Fazer desenhos ou escrever em locais não apropriados; (pichação, rabisco, estragar patrimônio)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 40, description: "Induzir outrem a erro ou falta; (induzir ao erro, influência negativa)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 41, description: "Não portar o Guia do Aluno ou outro documento de identificação, quando solicitado por autoridade competente; (carteirinha, identificação, guia)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 42, description: "Permanecer uniformizado em locais incompatíveis com a condição de aluno da EECM; (local impróprio, uniforme fora da escola)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 43, description: "Permitir que outro aluno utilize seu material ou peças de uniforme, sem autorização; (emprestar uniforme, material)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 44, description: "Praticar atos de vandalismo ou danos ao patrimônio da EECM ou de terceiros; (vandalismo, quebrar, danificar)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 45, description: "Realizar transações comerciais de qualquer natureza dentro da EECM; (venda, comércio, negócio)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 46, description: "Recusar-se a receber material escolar, uniforme ou outro objeto distribuído pela EECM; (recusa, desobediência)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 47, description: "Retirar-se da EECM, sem autorização; (sair sem permissão, fugir)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 48, description: "Sobrepor ao uniforme qualquer peça que não pertença ao mesmo; (agasalho estranho, acessório não permitido)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 49, description: "Ter em seu poder, objetos ou publicações que atentem contra a moral e os bons costumes; (pornografia, impróprio)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 50, description: "Tomar parte em jogos de azar; (aposta, jogo proibido)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 51, description: "Trazer para a EECM objetos de valor ou eletroeletrônicos sem autorização; (eletrônico, valor, proibido)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 52, description: "Usar o uniforme de forma incorreta ou desleixada; (desleixo, uniforme mal posto)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 53, description: "Utilizar-se de meios ilícitos em avaliações ou trabalhos escolares; (cola, plágio, trapaça)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 54, description: "Utilizar-se de telefone celular ou outros aparelhos eletrônicos durante a aula, sem autorização do professor; (celular, telefone, eletrônico)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 55, description: "Agir com desatenção ou falta de interesse durante a aula, instrução ou atividade escolar; (desatenção, preguiça)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 56, description: "Comparecer à EECM sem estar devidamente asseado; (higiene, asseio, sujeira)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 57, description: "Fazer uso de maquiagem excessiva, esmalte de cor não permitida ou outros adornos, quando uniformizado; (maquiagem, esmalte, adorno)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 58, description: "Manter contato físico que denote relacionamento amoroso (beijos, abraços, mãos dadas, etc.), estando uniformizado; (namoro, beijo, contato físico)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 59, description: "Omitir-se de prestar auxílio a colega, quando necessário e possível; (omissão, falta de companheirismo)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 60, description: "Proferir palavras de baixo calão; (palavrão, xingamento, baixo calão)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 61, description: "Sentar-se em locais não destinados a esse fim, como mesas, corrimãos, parapeitos, etc.; (sentar em lugar errado, postura)", severity: "Media", points: -1.0, measure: "Repreensão" },
  { code: 62, description: "Usar de gírias ao se dirigir a professores, militares ou funcionários; (gíria, falta de respeito, formalidade)", severity: "Media", points: -1.0, measure: "Repreensão" },
